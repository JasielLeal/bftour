...
const depoimentos = [
    ...
    {
        id: 6,
        nome: "Jonath Erick da Silva",
        cidade: "Natal, RN",
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Recomendo a todos. Valeu cada centavo. Super atenciosos.",
        avatar: "JS",
        color: "bg-cyan-500",
    },
    {
        id: 7,
        nome: "Rodrigo Damasceno",
        cidade: "Natal, RN",
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Os caras são fera demais! Senti muita segurança pelo trajeto que fazem. O caminho é lindo e o guia tira excelentes fotos! Esse passeio é obrigatório em BF e o pessoal é especialista em trabalhar bem. Minha experiência foi excepcional",
        avatar: "RD",
        color: "bg-yellow-500",
    },
    {
        ...
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Achei no Insta e era o passeio que mais estava esperando , desde o primeiro contato o atendimento impecável, educados e animados😊 o Passeio e incrível, praias desertas, museu das tartarugas....maravilhoso, quem for para Rio grande do Norte, não deixe de passar em Baía Formosa e fazer os passeios com eles!! …",
        avatar: "SM",
        color: "bg-yellow-500",
    },
    {
        id: 9,
        nome: "Fernanda Maschietto",
        cidade: "Natal, RN",
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Foi incrível o passeio de quadriciclo até a praia do Sagi! Mto divertido, paisagens lindas e conhecemos mais sobre a Baía Formosa com o João, que além de guia é um fotógrafo excelente!! Recomendamos mto!",
        avatar: "FM",
        color: "bg-pink-500",
    },
    {
        ...
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Q passeio maravilhoso 😍 👏🎉 adoramos e já quero voltar agradeço a baia formosa tour e ao amigo Júlio q foi nosso guia atendimento perfeito excelente sem palavra obrigado pelo dia . …",
        avatar: "GN",
        color: "bg-red-500",
    },
    {
        id: 11,
        nome: "Janine Bernardino",
        cidade: "Natal, RN",
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Incrível! Sempre quis fazer esse passeio. Amei tanto que repeti, e repetiria a dose mil vezes … Sem contar que fizemos o passeio com o Júlio, menino bom, atencioso, simpático e nos deixou super a vontade. Além de ser nosso melhor fotografo rs INCRÍVEL! 🥰🏝️",
        avatar: "JB",
        color: "bg-red-500",
    },
    {
        ...
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Excelente passeio. Motorista experiente. Belas paisagens e a lagoa da Coca-Cola e o museu das tartarugas foram as melhores partes",
        avatar: "RU",
        color: "bg-green-500",
    },
    {
        id: 13,
        nome: "Jolivia Cavalcante",
        cidade: "Natal, RN",
        experiencia: "Passeio de Quadriciclo",
        nota: 5,
        texto: "Tive experiências incríveis com os passeios do Baia Formosa Tour, sempre muito atenciosos e cuidadosos. Os passeios ficarão eternizados na memória de tão bons q foram, impecáveis em tudo!!!  Desde a rota até nas excelentes fotografias, tudo perfeito!!",
        avatar: "JC",
        color: "bg-indigo-500",
    }
