        ...
        <div className="bg-white" id="favorites">
            <div className="max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    {packages.map((item) => (
                        <Reveal key={item.id} delay={item.id * 90} className="h-full">
                            <Link 
                                href={item.href || "#"}
                                className="interactive-card block h-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm"
                            >
