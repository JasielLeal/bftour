                ...
                <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 pb-12 border-b border-slate-800">
                    ...
                    <Reveal className="lg:col-span-1">
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href="https://wa.me/5584994511101" target="_blank" rel="noreferrer" aria-label="WhatsApp"
                    ...
                    <Reveal delay={240}>
                        <div>
                            ...
                            <ul className="space-y-3 text-sm">
                                <li>
                                    <a href="tel:+5584994511101" className="hover:text-white transition-colors">(84) 9 9451-1101</a>
                                </li>
                                <li>
                            ...
                            <a
                                href="https://wa.me/5584994511101?text=Olá! Vim do site e gostaria de agendar uma experiência."
                                target="_blank"
                                rel="noreferrer"
